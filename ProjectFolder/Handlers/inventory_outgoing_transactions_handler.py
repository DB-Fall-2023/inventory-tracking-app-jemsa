...
def create_transaction():
    ...
    try:
        transaction = transaction_dao.create_transactions(part_id, rack_id, receiver_id, warehouse_id)
        response = {
...
def update_transactions(transaction_id):
    ...
    try:
        transactions_dao.update_transactions_by_id(transaction_id, part_id, rack_id, receiver_id, warehouse_id)
        transaction = transactions_dao.get_transactions_by_id(transaction_id)
        if transaction and (
